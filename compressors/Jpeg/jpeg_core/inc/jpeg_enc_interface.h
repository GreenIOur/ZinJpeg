#ifndef JPEG_INTERFACE
#define JPEG_INTERFACE
 ...
 * Default is 75
 */
void jpeg_set_quality(unsigned char q);
 ...
 * Default is 5
 */
void jpeg_set_distance(unsigned char d);
 ...
 * Default is 160x120
 */
void jpeg_set_size(unsigned short x, unsigned short y);
 ...
 * last reset occurred.
 */
unsigned jpeg_get_overhead_stats();
